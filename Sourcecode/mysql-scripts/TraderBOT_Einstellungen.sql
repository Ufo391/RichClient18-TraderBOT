CREATE DATABASE  IF NOT EXISTS `TraderBOT` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `TraderBOT`;
-- MySQL dump 10.13  Distrib 5.7.22, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: TraderBOT
-- ------------------------------------------------------
...
CREATE TABLE `Einstellungen` (
  ...
  `benutzer_email` varchar(64) NOT NULL,
  `247_istaktiv` tinyint(1) NOT NULL,
  `autologin` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Einstellungen_Benutzer_idx` (`benutzer_email`),
...
-- Dump completed on 2018-06-18 15:04:47
